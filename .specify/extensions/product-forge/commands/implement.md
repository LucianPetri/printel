...
4. If the feature touches EverShop workspaces, verify the plan names the required
   `npm run build:extensions` checkpoint before validation or release handoff
