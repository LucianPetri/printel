...
4. If the feature touches Romanian storefront, legal, privacy, consent, pricing, or locale behavior,
   record the required compliance and localization surfaces even when no separate feature dependency exists
5. If no related features found: **omit the Prerequisites section entirely** from `spec.md`
...
Contents:
  ...
  • Compliance surfaces: {Romanian storefront / legal / consent / localization impacts summarized or "No special compliance surfaces"}
